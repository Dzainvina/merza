...
ulang:
echo "\n";
echo "\e[1;37m tabikh pun  \n";
echo "\e[32;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\e[31;1m ( BANDARLAMPUNG$input)\e[32;1m ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
// function change(){
        $nama = nama();
        ...
        echo color("white","+] your access id : ".$token."\n\n");
     ...
     echo "\n".color("blue","⏩ MANTAN KE 1");
       ...
       $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD2107"}');
        ...
        echo "\n".color("green","         mantan ke 1. ".$voucher1);
        echo "\n".color("green","         mantan ke 2. ".$voucher2);
        echo "\n".color("green","         mantan ke 3. ".$voucher3);
        echo "\n".color("green","         mantan ke 4. ".$voucher4);
        echo "\n".color("green","         mantan ke 5. ".$voucher5);
        echo "\n".color("green","         mantan ke 6. ".$voucher6);
        echo "\n".color("green","         mantan ke 7. ".$voucher7);
        echo "\n".color("green","         mantan ke 8. ".$voucher8);
        echo "\n".color("green","         mantan ke 9. ".$voucher9);
        echo "\n".color("green","         mantan ke 10. ".$voucher10);
      	echo "\n".color("green","         mantan ke 11. ".$voucher11);
        echo "\n".color("green","         mantan ke 12. ".$voucher12);
        echo "\n".color("green","         mantan ke 13. ".$voucher13);
        echo"\n";
